...
ActiveRecord::Schema.define(:version => 20130620125056) do
  ...
  create_table "moulds", :force => true do |t|
    ...
    t.date     "birthday"
    t.integer  "cavities"
    t.float    "material_consumption"
    t.float    "net_output"
    t.float    "cycletime"
    t.float    "product_net_weight"
    t.float    "product_gross_weight"
    t.float    "mould_change_time"
    t.integer  "plastic_material_type_id"
    t.datetime "created_at",               :null => false
    t.datetime "updated_at",               :null => false
  end

  add_index "moulds", ["plastic_material_type_id"], :name => "index_moulds_on_plastic_material_type_id"
  add_index "moulds", ["process_type_id"], :name => "index_moulds_on_process_type_id"

  create_table "plastic_material_types", :force => true do |t|
    t.string   "name"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end
